    ...
    <div class="glass-header animate__animated animate__fadeIn">
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <h1 class="display-5 fw-bold text-white mb-1">Administrative <span class="text-info">Command</span></h1>
        ...
        <div class="col-lg-4 animate__animated animate__fadeInRight">
            <div class="bento-card">
                ...
                <div class="d-grid mt-3">
                    <button class="btn btn-outline-info rounded-pill py-2 small fw-bold">View Full Registry</button>
                </div>
            </div>
        </div>
    </div>
